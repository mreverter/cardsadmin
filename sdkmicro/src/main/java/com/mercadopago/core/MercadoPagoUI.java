...
public class MercadoPagoUI {
    ...
    public static class Activities {
        ...
        public static class PaymentMethodsActivityBuilder {
            ...
            public PaymentMethodsActivityBuilder setDecorationPrefernece(DecorationPreference decorationPreference) {
                this.decorationPreference = decorationPreference;
                return this;
            }
        ...
        public static class InstructionsActivityBuilder {
            ...
            public void startActivity() {
                if (this.activity == null) throw new IllegalStateException("activity is null");
                if (this.payment == null) throw new IllegalStateException("payment is null");
                if (this.paymentTypeId == null) throw new IllegalStateException("payment type id is null");
                if (this.merchantPublicKey == null) throw new IllegalStateException("public key is null");
        ...
        public static class BankDealsActivityBuilder {
            ...
            public BankDealsActivityBuilder setDecorationPrefernece(DecorationPreference decorationPreference) {
                this.decorationPreference = decorationPreference;
                return this;
            }
    ...
    public static class Views {
        ...
        public static class SavedCardsListViewBuilder {
            ...
            public SavedCardsListViewBuilder setSelectionImage(Drawable selectionImage) {
                this.selectionImage = selectionImage;
                return this;
            }

            public SavedCardsListView build() {
                return new SavedCardsListView(context, cards, footerText, onSelectedCallback, selectionImage);
            }
        }
        ...
        public static class SavedCardViewBuilder {
            ...
            public SavedCardViewBuilder setSelectionDrawable(Drawable selectionDrawable) {
                this.selectionDrawable = selectionDrawable;
                return this;
            }

            public SavedCardView build() {
                return new SavedCardRowView(context, card, selectionDrawable);
            }
        }
    }
}

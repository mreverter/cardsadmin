...
public class MercadoPago {
    ...
    private static void startCustomerCardsActivity(Activity activity, List<Card> cards, String title, Boolean footerEnabled, String footerMessage, DecorationPreference decorationPreference) {
        ...
        paymentMethodsIntent.putExtra("title", title);
        paymentMethodsIntent.putExtra("footerEnabled", footerEnabled);
        paymentMethodsIntent.putExtra("footerMessage", footerMessage);
    ...
    public static class StartActivityBuilder {
        ...
        public StartActivityBuilder setTitle(String title) {
        ...
        /**
         *  @deprecated Should use MercadoPagoUI.SavedCardsActivityBuilder#startActivity.
         */
        @Deprecated
        public void startCustomerCardsActivity() {
            ...
            MercadoPago.startCustomerCardsActivity(this.mActivity, this.mCards, this.mTitle, this.mFooterEnabled, this.mFooterMessage, this.mDecorationPreference);
        }
        ...
        public StartActivityBuilder setFooterMessage(String message) {
            this.mFooterMessage = message;
            return this;
        }

        public StartActivityBuilder disableFooter() {

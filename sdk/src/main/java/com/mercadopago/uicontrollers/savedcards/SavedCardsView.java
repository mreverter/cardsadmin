 ...
 */
public class SavedCardsView implements CustomViewController {
    ...
    public SavedCardsView(Context context, List<Card> cards, String footerText, OnSelectedCallback<Card> onSelectedCallback) {
        mContext = context;
    ...
    public void drawInParent(ViewGroup parent) {
        ...
        // Load cards
        mSavedCardsRecyclerView.setAdapter(new CustomerCardsAdapter(mContext, mCards, mOnselectedCallback));
